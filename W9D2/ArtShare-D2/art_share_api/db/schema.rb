...
ActiveRecord::Schema.define(version: 2020_01_23_001503) do
  ...
  create_table "favorites", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id", "artwork_id"], name: "index_favorites_on_user_id_and_artwork_id"
  end
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["likeable_id", "user_id"], name: "index_likes_on_likeable_id_and_user_id"
